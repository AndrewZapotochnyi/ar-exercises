...
@womens_stores = Store.where('annual_revenue > :annual_revenue AND womens_apparel = :womens_apparel', annual_revenue: 1000000, womens_apparel: true)
puts @womens_stores

for store in @womens_stores
  puts store.name
  puts store.annual_revenue
  puts store.womens_apparel
end