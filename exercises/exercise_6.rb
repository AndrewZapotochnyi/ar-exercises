...
@store1.employees.create(first_name: "Khurram", last_name: "Virani", hourly_rate: 60)
@store1.employees.create(first_name: "Andrew", last_name: "Zapotochnyi", hourly_rate: 120)
@store1.employees.create(first_name: "Michael", last_name: "Matich", hourly_rate: 120)

@store2.employees.create(first_name: "Rachel", last_name: "Kat", hourly_rate: 120)
@store2.employees.create(first_name: "Ron", last_name: "Juarez", hourly_rate: 120)
@store2.employees.create(first_name: "Vasily", last_name: "Klimkin", hourly_rate: 120)